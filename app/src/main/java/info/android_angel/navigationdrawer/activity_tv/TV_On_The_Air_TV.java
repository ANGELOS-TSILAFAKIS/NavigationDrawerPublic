...
public class TV_On_The_Air_TV extends AppCompatActivity {
    ...
    private static final String TAG = TV_On_The_Air_TV.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<TVResponse> call = apiService.getOnTheAirTv(getResources().getString(R.string.API_KEY));
        ...
        Call<TVResponse> call_2 = apiService.getOnTheAirTv_2(getResources().getString(R.string.API_KEY), page_2);
        ...
        Call<TVResponse> call_3 = apiService.getOnTheAirTv_2(getResources().getString(R.string.API_KEY), page_3);
