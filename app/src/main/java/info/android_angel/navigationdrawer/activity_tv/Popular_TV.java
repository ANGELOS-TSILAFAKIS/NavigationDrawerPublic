...
public class Popular_TV extends AppCompatActivity {
    ...
    private static final String TAG = Popular_TV.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<TVResponse> call = apiService.getPopularTv(getResources().getString(R.string.API_KEY));
...
**/
        ...
        Call<TVResponse> call_2 = apiService.getPopularTv_2(getResources().getString(R.string.API_KEY), page_2);
        ...
        Call<TVResponse> call_3 = apiService.getPopularTv_2(getResources().getString(R.string.API_KEY), page_3);
