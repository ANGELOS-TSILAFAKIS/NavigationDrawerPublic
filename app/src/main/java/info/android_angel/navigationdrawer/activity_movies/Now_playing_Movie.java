 ...
 *
 *  Οι τέσσερις κλάσεις είναι η Now_playing_Movie,
 *  Popular_Movie,
 * Top_Rated_Movie, Upcoming_Movie.
 *
 */
...
public class Now_playing_Movie extends AppCompatActivity {
    ...
    public static final String KEY_MOVIE_Overview = "key_movie_overview";
    public static final String KEY_MOVIE_OriginalTitle = "key_book_original_title";
    public static final String KEY_MOVIE_OriginalLanguage = "key_book_original_language";
    public static final String KEY_MOVIE_Title = "key_book_title";
    ...
    private void search(SearchView searchView) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Toast.makeText(Now_playing_Movie.this, "Search is Selected", Toast.LENGTH_SHORT).show();

                Intent i = new Intent(Now_playing_Movie.this,SearchActivity.class);
                ...
                String switch_key_activity = "Now_playing_Movie_String";
