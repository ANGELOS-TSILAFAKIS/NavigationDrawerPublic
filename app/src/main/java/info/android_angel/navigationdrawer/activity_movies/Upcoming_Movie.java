...
public class Upcoming_Movie extends AppCompatActivity {
    ...
    private static final String TAG = Upcoming_Movie.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<MoviesResponse> call = apiService.getUpcomingMovies(getResources().getString(R.string.API_KEY));
        ...
        Call<MoviesResponse> call_2 = apiService.getUpcomingMovies_2(getResources().getString(R.string.API_KEY), page_2);
        ...
        Call<MoviesResponse> call_3 = apiService.getUpcomingMovies_2(getResources().getString(R.string.API_KEY), page_3);
