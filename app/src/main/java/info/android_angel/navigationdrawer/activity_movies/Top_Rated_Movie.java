...
public class Top_Rated_Movie extends AppCompatActivity {
    ...
    private static final String TAG = Top_Rated_Movie.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<MoviesResponse> call = apiService.getTopRatedMovies(getResources().getString(R.string.API_KEY));
        ...
        Call<MoviesResponse> call_2 = apiService.getTopRatedMovies_2(getResources().getString(R.string.API_KEY), page_2);
        ...
        Call<MoviesResponse> call_3 = apiService.getTopRatedMovies_2(getResources().getString(R.string.API_KEY), page_3);
